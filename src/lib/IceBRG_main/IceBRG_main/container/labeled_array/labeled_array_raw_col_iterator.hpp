/**********************************************************************\
 @file labeled_array_raw_col_iterator.hpp
 ------------------
...
#ifndef _BRG_CONTAINER_LABELED_ARRAY_LABELED_ARRAY_RAW_COL_ITERATOR_HPP_INCLUDED_
#define _BRG_CONTAINER_LABELED_ARRAY_LABELED_ARRAY_RAW_COL_ITERATOR_HPP_INCLUDED_
...
private:
	// Private typedefs
	typedef typename boost::iterator_facade<labeled_array_raw_col_iterator<labeled_array_type,T,T_reference>,
...
private:
    ...
    bool equal(const labeled_array_raw_col_iterator<labeled_array_type,T,T_reference> & other) const
    {
    ...
    difference_type distance_to(
    	const labeled_array_raw_col_iterator<labeled_array_type,T,T_reference> & other) const
    {
    	return other._col_index_-_col_index_;
    }

    T_reference dereference() const { return _base_->raw_col(_col_index_); }

#endif

public:
	labeled_array_raw_col_iterator()
	: _base_(), _col_index_()
	{
	}

	labeled_array_raw_col_iterator(labeled_array_type * base, const size_t & col_index)
...
#endif // _BRG_CONTAINER_LABELED_ARRAY_LABELED_ARRAY_RAW_COL_ITERATOR_HPP_INCLUDED_
