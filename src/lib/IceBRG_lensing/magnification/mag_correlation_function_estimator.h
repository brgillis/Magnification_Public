/**********************************************************************\
 @file mag_correlation_function_estimator.h
 ------------------
...
#ifndef _BRG_LENSING_MAGNIFICATION_MAG_CORRELATION_FUNCTION_ESTIMATOR_H_INCLUDED_
#define _BRG_LENSING_MAGNIFICATION_MAG_CORRELATION_FUNCTION_ESTIMATOR_H_INCLUDED_
 ...
 *
 */
class mag_correlation_function_estimator {
private:
...
public:
	...
	mag_correlation_function_estimator()
	: _z_buffer_(0)
	{
	}
	...
	template<typename T>
	mag_correlation_function_estimator(T && D_bin_limits, const flt_type & z_buffer=0)
	...
	mag_correlation_function_estimator(TR1 && D1_pos_list, TR2 && D2_pos_list,
	...
	mag_correlation_function_estimator(T && D_bin_limits,
	...
	// Virtual destructor
	virtual ~mag_correlation_function_estimator()
	{
	}
...
#endif // _BRG_LENSING_MAGNIFICATION_MAG_CORRELATION_FUNCTION_ESTIMATOR_H_INCLUDED_
